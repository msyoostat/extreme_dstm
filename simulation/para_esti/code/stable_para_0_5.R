...
hyper_beta_d<-0.1
hyper_alpha_nu1<-10
hyper_beta_nu1<-1.1*(hyper_alpha_nu1-1)
hyper_alpha_nu2<-20
...
proposal_sd_nu<-0.2
proposal_sd_lambda<-0.2
proposal_sd_kappa<-0.2
proposal_beta_sd<-1.4
proposal_delta_sd<-2.4
...
# save --------------------------------------------------------------------
#### save .RData file
#save.image("stable_para_0_5.RData")
